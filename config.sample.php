...
*/
const CONFIG_SRV_NAME = 'Pear';
//Please don't enable NSS or else your instance will die
const CONFIG_SRV_NSS = false;
const CONFIG_SRV_TYPE = 1;
// 0 - dev, 1 - prod
const CONFIG_SRV_ENV = 'P1';
...
const CONFIG_DB_SERVER = 'localhost';
const CONFIG_DB_USER = 'root';
const CONFIG_DB_PASS = '';
const CONFIG_DB_NAME = 'pear';
...
// reCAPTCHA keys
// PS : it's not required to have these
...
$grp_config_allow_allimages = true;
